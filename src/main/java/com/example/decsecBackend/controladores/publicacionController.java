...
public class publicacionController {
    ...
    @PatchMapping("/{id}")
    @PreAuthorize("hasRole('ROLE_USER')")
    public ResponseEntity<?> actualizarParcialmente(@PathVariable(required = true) Long id, @AuthenticationPrincipal Usuario usuario, @RequestBody Map<String, Object> updates){
